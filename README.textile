...
This is a library for the "Arduino":http://pololu.com/catalog/product/2191 for controlling these addressable RGB LED strips from Pololu:
...
This library does not support the older low-speed LED strips.  If you want to control those, we recommend using "version 1.2.0":https://github.com/pololu/pololu-led-strip-arduino/releases/tag/1.2.0, which can work with either the high-speed or low-speed versions.
