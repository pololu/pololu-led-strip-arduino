...
This library also supports addressable through-hole RGB LEDs from Pololu, which are listed below.  However, the red and green channels on these LEDs are swapped relative to the WS2812B, so you will need to swap those channels in your code.
...
If you have the WS2811 LEDs or the high-speed TM1804 LED strips, you might prefer to use "version 2.1.0":https://github.com/pololu/pololu-led-strip-arduino/releases/tag/2.1.0 of the library, which does not require you to swap red and green in your code.
